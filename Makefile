...
OBJ_DEBUG = $(OBJDIR_DEBUG)/src/cbp2make.o $(OBJDIR_DEBUG)/src/cbproject.o $(OBJDIR_DEBUG)/src/cbptarget.o $(OBJDIR_DEBUG)/src/cbpunit.o $(OBJDIR_DEBUG)/src/cbworkspace.o $(OBJDIR_DEBUG)/src/depsearch.o $(OBJDIR_DEBUG)/src/cbhelper.o $(OBJDIR_DEBUG)/src/makefile.o $(OBJDIR_DEBUG)/src/platforms.o $(OBJDIR_DEBUG)/src/toolchains.o $(OBJDIR_DEBUG)/lib/stlconfig.o $(OBJDIR_DEBUG)/lib/stlconvert.o $(OBJDIR_DEBUG)/lib/stlfutils.o $(OBJDIR_DEBUG)/lib/stlgpm.o $(OBJDIR_DEBUG)/lib/stlstrings.o $(OBJDIR_DEBUG)/lib/stlvariables.o $(OBJDIR_DEBUG)/lib/stringhash.o $(OBJDIR_DEBUG)/lib/tinyxml/tinystr.o $(OBJDIR_DEBUG)/lib/tinyxml/tinyxml.o $(OBJDIR_DEBUG)/lib/tinyxml/tinyxmlerror.o $(OBJDIR_DEBUG)/lib/tinyxml/tinyxmlparser.o $(OBJDIR_DEBUG)/src/buildtools.o $(OBJDIR_DEBUG)/src/cbbuildcfg.o $(OBJDIR_DEBUG)/src/cbbuildmgr.o $(OBJDIR_DEBUG)/src/cbglobalvar.o

OBJ_RELEASE = $(OBJDIR_RELEASE)/src/cbp2make.o $(OBJDIR_RELEASE)/src/cbproject.o $(OBJDIR_RELEASE)/src/cbptarget.o $(OBJDIR_RELEASE)/src/cbpunit.o $(OBJDIR_RELEASE)/src/cbworkspace.o $(OBJDIR_RELEASE)/src/depsearch.o $(OBJDIR_RELEASE)/src/cbhelper.o $(OBJDIR_RELEASE)/src/makefile.o $(OBJDIR_RELEASE)/src/platforms.o $(OBJDIR_RELEASE)/src/toolchains.o $(OBJDIR_RELEASE)/lib/stlconfig.o $(OBJDIR_RELEASE)/lib/stlconvert.o $(OBJDIR_RELEASE)/lib/stlfutils.o $(OBJDIR_RELEASE)/lib/stlgpm.o $(OBJDIR_RELEASE)/lib/stlstrings.o $(OBJDIR_RELEASE)/lib/stlvariables.o $(OBJDIR_RELEASE)/lib/stringhash.o $(OBJDIR_RELEASE)/lib/tinyxml/tinystr.o $(OBJDIR_RELEASE)/lib/tinyxml/tinyxml.o $(OBJDIR_RELEASE)/lib/tinyxml/tinyxmlerror.o $(OBJDIR_RELEASE)/lib/tinyxml/tinyxmlparser.o $(OBJDIR_RELEASE)/src/buildtools.o $(OBJDIR_RELEASE)/src/cbbuildcfg.o $(OBJDIR_RELEASE)/src/cbbuildmgr.o $(OBJDIR_RELEASE)/src/cbglobalvar.o

OBJ_PROFILE = $(OBJDIR_PROFILE)/src/cbp2make.o $(OBJDIR_PROFILE)/src/cbproject.o $(OBJDIR_PROFILE)/src/cbptarget.o $(OBJDIR_PROFILE)/src/cbpunit.o $(OBJDIR_PROFILE)/src/cbworkspace.o $(OBJDIR_PROFILE)/src/depsearch.o $(OBJDIR_PROFILE)/src/cbhelper.o $(OBJDIR_PROFILE)/src/makefile.o $(OBJDIR_PROFILE)/src/platforms.o $(OBJDIR_PROFILE)/src/toolchains.o $(OBJDIR_PROFILE)/lib/stlconfig.o $(OBJDIR_PROFILE)/lib/stlconvert.o $(OBJDIR_PROFILE)/lib/stlfutils.o $(OBJDIR_PROFILE)/lib/stlgpm.o $(OBJDIR_PROFILE)/lib/stlstrings.o $(OBJDIR_PROFILE)/lib/stlvariables.o $(OBJDIR_PROFILE)/lib/stringhash.o $(OBJDIR_PROFILE)/lib/tinyxml/tinystr.o $(OBJDIR_PROFILE)/lib/tinyxml/tinyxml.o $(OBJDIR_PROFILE)/lib/tinyxml/tinyxmlerror.o $(OBJDIR_PROFILE)/lib/tinyxml/tinyxmlparser.o $(OBJDIR_PROFILE)/src/buildtools.o $(OBJDIR_PROFILE)/src/cbbuildcfg.o $(OBJDIR_PROFILE)/src/cbbuildmgr.o $(OBJDIR_PROFILE)/src/cbglobalvar.o

default_all: debug release doxygen profile
